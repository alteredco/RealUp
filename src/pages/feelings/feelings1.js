...
class Feelings1 extends Component {
  constructor(props) {
    ...
    this.state = {
      feelings1Txt:
        "Impostor Syndrome can cause feelings of anxiety, fear, and depression.",
      feelings2Txt:
        "Real Up is here to help you manage through this physiological response.",
  ...
  render() {
    return (
      <div className="row center-align">
        <div>
          <TextLines text={this.state.feelings1Txt} />
        </div>
        <div>
